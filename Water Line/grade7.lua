...
while true do
    ...
    if gt.getWorkMaxProgress() == 0 then
        ...
        if signal == 0 then
            ...
            ae2_lib.requestRecipeCancel(coolant, 1, "7", 2)
        else
            bit1 = signal & 1
            bit2 = (signal >> 1) & 1
            bit3 = (signal >> 2) & 1
